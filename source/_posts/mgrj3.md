...
categories:
  - Hexo魔改
cover: 'https://bu.dusays.com/2022/12/07/6390965087183.png'
abbrlink: 670e47f
...
![](https://bu.dusays.com/2022/12/07/6390952438d00.png)
...
![](https://bu.dusays.com/2022/12/07/6390954b8e797.png)

bbTalk已经停止维护且无官方的轮播插件，但是因为方便我还是在用，轮播我自己写了一个，之前的版本因为过于屎山与毒瘤并没有放出来，这次进行了pjax&swiper重构。

支持日期展示、自动链接替换(22.12.9 upd)，目前依然有部分bug：

![](https://bu.dusays.com/2022/12/07/63908ccba577b.png)

![](https://bu.dusays.com/2022/12/09/6392a7d10ed30.png)
...
```html
<script src="https://cdn.jsdelivr.net/npm/leancloud-storage@4.13.4/dist/av-min.js"></script>
```
...
{% link 适配指北：我是怎么适配PJAX的,Zhpxfyの小窝,https://jcblog.cf/posts/30bce1d1/ %}
...
![](https://bu.dusays.com/2022/12/07/63909a156a09e.png)
![](https://bu.dusays.com/2022/12/07/63909a1ed054d.png)

重构的博客设置，性能和ui美观度均有提高（目前仍有部分bug欢迎反馈）

新版博客设置进行了分区改造，把rightside全部转移到此，优化样式，性能优化，以及进行了前后端分离。

请先阅读这篇[之前的文章](https://jcblog.cf/posts/ac792cf4/#%E5%8D%9A%E5%AE%A2%E8%AE%BE%E7%BD%AE)来参考修改
    ...
    #settingWindow.js-pjax
            ...
            #setting-hides
                ...
                #background-settings.asetting
                    ...
                    .bgbox
                        ...
                        a.imgbox(href='javascript:;', onclick='changeBg(\'url(https://data-static.netdun.net/Fomalhaut/img/default_cover_4.webp)\')')
                            img(src='https://data-static.netdun.net/Fomalhaut/img/default_cover_4.webp')
                        ...
                        a.imgbox(href='javascript:;', onclick='changeBg(\'url(https://data-static.netdun.net/Fomalhaut/img/default_cover_6.webp)\')')
                            img(src='https://data-static.netdun.net/Fomalhaut/img/default_cover_6.webp')
        ...
        #setting-sidesl
            ...
            #setting-sides
                ...
                button(title="昼夜切换" class="con-rightside" id="con-mode" onclick="rmf.switchDarkMode();")
                    i.fa.fa-adjust
                if is_post()||is_page()
...
![](https://bu.dusays.com/2022/12/08/63912c6163159.png)

![](https://bu.dusays.com/2022/12/08/63912cfe00f7a.png)

![](https://bu.dusays.com/2022/12/08/63912cadca91a.png)
...
{% link butterfly博客自定义右键菜单升级版,Zhpxfyの小窝,/posts/11eb4aac/ %}
...
![](https://bu.dusays.com/2022/12/09/639298b0cb16b.png)
...
# see https://jcblog.cf/posts/670e47f/#%E6%9B%B4%E5%A5%BD%E7%9A%84%E9%A6%96%E9%A1%B5%E8%BD%AE%E6%92%AD
swiper:
  enable: true # 开关
  priority: 5 # 过滤器优先权
