...
此教程要求你使用cloudflare的dns，如果不是，请换成cloudflare来解析，不然不能绑定（可以自己用partner或者之前[那篇文章](https://jcblog.cf/posts/e433f3d.html)的类似的蒙混过关法，he不知可否）
...
![1659499308874](https://cdn1.tianli0.top/npm/oldimagescdn-ariasaka@latest/goormcustomdomain/1659499308874.png)
...
```bash
cloudflared tunnel route dns hexoblog vps.yisous.xyz #hexoblog这个隧道映射到vps,jcblog.cf这个域名
```
...
![1659501476381](https://cdn1.tianli0.top/npm/oldimagescdn-ariasaka@latest/goormcustomdomain/1659501476381.png)
